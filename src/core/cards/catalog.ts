...
export const CARDS: readonly Card[] = [
  ...
  },
  {
    ...
    text: 'Nimm 1 beliebigen Rohstoff. Bankhandel kostet dich dauerhaft eine Karte weniger.',
  ...
  },
  {
    ...
    name: 'Vorratskammer',
    rarity: 'ungewoehnlich',
    text: 'Nimm 3 beliebige Rohstoffe. Du darfst dauerhaft 2 Karten mehr halten.',
  ...
  },
  {
    ...
    name: 'Wanderhaendler',
    rarity: 'ungewoehnlich',
    text: 'Nimm 5 beliebige Rohstoffe.',
  ...
  },
  {
    ...
    name: 'Karge Jahre',
    rarity: 'selten',
    text: 'Nimm 10 beliebige Rohstoffe. Weiden liefern dir dauerhaft 1 weniger.',
  ...
  },
  {
    ...
    name: 'Markttag',
    rarity: 'selten',
    text: 'Nimm 4 beliebige Rohstoffe. Bankhandel kostet dich dauerhaft eine Karte weniger.',
  ...
  },
  {
    ...
    name: 'Grosse Scheune',
    rarity: 'episch',
    text: 'Nimm 8 beliebige Rohstoffe. Du darfst dauerhaft 4 Karten mehr halten.',
  ...
  },
  {
    ...
    name: 'Handelsflotte',
    rarity: 'episch',
    text: 'Nimm 4 beliebige Rohstoffe. Bankhandel kostet dauerhaft eine Karte weniger, Haefen bleiben im Sturm offen.',
    instant: { t: 'gainAny', count: 4 },
  ...
  // --- legendaer: Wert 22 bis 30 --------------------------------------------
  {
    ...
    name: 'Uralter Hain',
    rarity: 'legendaer',
    text: 'Nimm 6 beliebige Rohstoffe. Waelder liefern dir dauerhaft +2 Holz.',
